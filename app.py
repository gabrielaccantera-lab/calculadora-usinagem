...
st.markdown(f"""
<style>
body, .stApp {{ background-color: {JD_CINZA_CLR}; }}
.jd-header {{
    background: {JD_VERDE_ESC};
    padding: 16px 24px; border-radius: 10px;
    border-left: 6px solid {JD_AMARELO};
    margin-bottom: 20px;
}}
...
.jd-section {{
    font-size: 15px; font-weight: 700; color: {JD_VERDE_ESC};
    border-left: 4px solid {JD_AMARELO}; padding-left: 10px;
    margin: 22px 0 10px;
}}
.jd-sub {{
    font-size: 12px; font-weight: 600; color: {JD_VERDE};
    margin: 12px 0 4px; text-transform: uppercase; letter-spacing: .04em;
}}

.badge-ok    {{ background:{JD_VERDE};color:white;padding:2px 8px;border-radius:12px;font-size:11px;font-weight:600; }}
.badge-warn  {{ background:{JD_AMARELO_ESC};color:white;padding:2px 8px;border-radius:12px;font-size:11px;font-weight:600; }}
...
.aviso-warn  {{ background:#FFFDE7;border-left:4px solid {JD_AMARELO_ESC};border-radius:6px;padding:9px 13px;margin:5px 0;font-size:12px;color:#7B5800; }}
.aviso-ok    {{ background:#E8F5E9;border-left:4px solid {JD_VERDE};border-radius:6px;padding:9px 13px;margin:5px 0;font-size:12px;color:{JD_VERDE_ESC}; }}

.formula-box {{
    background:#1A1A1A;color:#A8E6A3;font-family:monospace;
    padding:10px 14px;border-radius:6px;font-size:12px;line-height:1.8;
    border-left:3px solid {JD_AMARELO};
}}
.mem-step {{
    background:white;border:1px solid {JD_CINZA_BD};border-radius:8px;
    padding:12px 16px;margin:6px 0;
}}
.mem-step .step-num {{
    background:{JD_VERDE_ESC};color:white;border-radius:50%;
    width:22px;height:22px;display:inline-flex;align-items:center;
    justify-content:center;font-size:11px;font-weight:700;margin-right:8px;
}}
.diff-igual   {{ background:#E8F5E9;color:{JD_VERDE_ESC};font-weight:600;padding:2px 6px;border-radius:4px; }}
...
.log-ok   {{ color:{JD_VERDE}; }}
.log-warn {{ color:{JD_AMARELO_ESC}; }}
